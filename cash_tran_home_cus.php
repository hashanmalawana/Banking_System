...
<div  class="modal">
<div class="opacity"> 
<form class="modal-content " method="post" action="cash_tran_home_cus.php">
<header>
<h3>Customer Service Officer</h3>
<h2 ><center>Account Details</center></h2>
</header>
<div class="container">
<input type="button" accesskey="1" value="All Transection" name="back"ONCLICK="window.location.href='cash_tran_totaltra_cus.php' ""/>
</div>
...
<input type="button" accesskey="b" value="Back" name="back"ONCLICK="window.location.href='show_cus_acc.php' ""/>
