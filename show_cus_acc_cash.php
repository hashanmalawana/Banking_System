...
if (isset($_POST['btn-view'])) {
 ...
 header("Location:cus_acc_detail_cash.php");
...
<title>Cash :<?php echo  $userRow['user_id']; ?>
</title>
<body>
...
<footer> 
<button type="submit" accesskey="e" class="btn btn-default" name="btn-view" id="btn-view"> &nbsp; Enter
</button>       
<input type="button" accesskey="c" value="Cancel" onclick="window.location.href='cash_ser.php?back'" />
</footer>     
</form>
</div>
</div>
